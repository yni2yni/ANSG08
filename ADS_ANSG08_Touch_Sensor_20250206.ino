...
// Code: 
// Date: 2025.02.06  Ver.: 0.0.4
// H/W Target: ARDUINO UNO R3, S/W: Arduino IDE  2.3.4
...
//Change the value of the register 0x12h when a problem occurs due to voltage drop
   Wire.write(byte(0x92)); //0x13h // EMC-CS Noise Filter1
   ...
   Wire.write(byte(0x2B)); //0x18h // EMC-CS Noise Filter2
   ...
   //if low frequency Noise = 0x40
   //Wire.write(byte(0x02)); // data
   //sesning Freq. High Band, RF Cal. Hold Fast = 0x02
   //sesning Freq. Low Band, RF Cal. Hold Fast = 0x82
   Wire.endTransmission(); //   
